...
<body style="padding-top: 70px">
 <?php include("navbar.php") ?>
    ...
    <div class="container ">
        <h2>Patient</h2>
        <form method="post"><?php include("../included/PatientDelete.php") ?>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="pFName" name="pFName" placeholder="Enter Name" value="<?php echo $row["FName"]; ?>" readonly />
            </div>
            ...
            <div class="form-group">
                ...
                <input type="tel" class="form-control" id="pTel2" name="pTel2" value="<?php echo $row["Tel2"]; ?>" placeholder="Enter Phone readonly" readonly />
            </div>

            <div class="form-group">
                <label for="pAddress">Address</label>
                <input type="text" class="form-control" id="pAddress" name="pAddress" placeholder="Enter Address " value="<?php echo $row["Adress"]; ?>" readonly />
            </div>
            <div class="form-group">
                <label for="pnationalId">CPR No</label>
                <input type="text" class="form-control" id="pnationalId" name="pnationalId" placeholder="Enter CPR" value="<?php echo $row["nationalId"]; ?>" readonly />
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="pContactTel" name="pContactTel" placeholder="Enter Contact Phone "
                       value="<?php echo $row["ContactTel"]; ?>" readonly />
            </div>

            <div class="form-group">
                <label for="pNatianlity">Nationality</label>
                <select id="pNatianlity" name="pNatianlity" class="form-control" value="<?php echo $row["Natianlity"]; ?>" readonly>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="pAssurance" name="pAssurance" placeholder="Enter Contact Phone " value="<?php echo $row["Assurance"]; ?>" readonly />
            </div>
