...
<body style="padding-top: 70px"><?php include("navbar.php") ?>
    <div class="container ">
        ...
        <span id="imessage" style="color: red;">
            <?php include("../included/HospitalDetails.php") ?> </span>
            <form method="post">
                ...
                <div class="form-group">
                    <label for="popenh1">Open Time</label>
                     <input type="time" class="form-control" id="popenh1" name="popenh1" placeholder="Enter Time " value="<?php echo $row["openh1"]; ?>" readonly>
                    
                </div>

                <div class="form-group">
                    <label for="popenh2">Close Time</label>
                    <input type="time" class="form-control" id="popenh2" name="popenh2" placeholder="Enter Time " value="<?php echo $row["openh2"]; ?>" readonly>
                   
                </div>

          

                <a class="btn btn-secondary" href="Hospitals.php">Return</a>
            </form>
    </div>
</body>
</html>