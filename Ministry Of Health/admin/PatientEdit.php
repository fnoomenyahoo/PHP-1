...
<body style="padding-top: 70px">
 <?php include("navbar.php") ?>
    <h2>Patient Edit</h2>
    <div class="container ">
        <h2>Patient</h2>    <span id="imessage" style="color: red;"><?php include("../included/PatientEdit.php") ?></span>
            <form method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="pFName" name="pFName" placeholder="Enter Name" value="<?php echo $row["FName"]; ?>" required />
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="tel" class="form-control" id="pTel2" name="pTel2" value="<?php echo $row["Tel2"]; ?>" placeholder="Enter Phone " />
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="pnationalId" name="pnationalId" placeholder="Enter CPR" value="<?php echo $row["nationalId"]; ?>" required />
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="pContactTel" name="pContactTel" placeholder="Enter Contact Phone "
                           value="<?php echo $row["ContactTel"]; ?>" required />
                </div>

                <div class="form-group">
                    <label for="pNatianlity">Nationality</label>
                    <select id="pNatianlity" name="pNatianlity" class="form-control" value="<?php echo $row["Natianlity"]; ?>" required>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="pAssurance" name="pAssurance" placeholder="Enter Contact Phone " value="<?php echo $row["Assurance"]; ?>" />
                </div>
