...
if($msg==""){
$query="INSERT INTO `hospital`( `Description`, `Tel`, `Tel2`, `Address`, `nationalId`, `Fax`, `Email`, `Status`, `ContactName`, `ContactTel`, `openh1`, `openh2`, `offDay`)
VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?)";

$rs= $db->prepare($query);
$rs->execute( array( $_POST["pDescription"], $_POST["pTel"], $_POST["pTel2"], $_POST["pAddress"], $_POST["pnationalId"], $_POST["pFax"], $_POST["pEmail"], $status,  $_POST["pContactName"], $_POST["pContactTel"], $_POST["popenh1"], $_POST["popenh2"], $poffDay));
